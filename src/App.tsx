        ...
        <div className={`${transitionBase} ${isVisible ? visible : hidden} delay-400`}>
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 mb-16">
            <a 
              ...
              onClick={() => track('calendly_click', { portfolio: 'dark', location: 'contact_section' })}
              target="_blank"
            ...
            <a 
              ...
              onClick={() => track('email_click', { portfolio: 'dark' })}
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-12">
            {socialLinks.map((social) => (
              <a 
                key={social.name}
                href={social.url}
                onClick={() => track('social_click', { platform: social.name.toLowerCase(), portfolio: 'dark' })}
                target="_blank"
                rel="noopener noreferrer"
  ...
  const projects = [
    ...
    },
    {
    ...
    },
     {
      ...
      description: "Needed an engaging platform for personal growth assessment.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            <a 
              key={index}
              href={project.link}
              onClick={() => track('project_click', { project: project.title, portfolio: 'dark' })}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <div className="relative z-10 max-w-7xl w-full flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-end justify-between w-full gap-8 md:gap-12">
                ...
                <div className={`${transitionBase} ${mounted ? visible : hidden} delay-[700ms]`}>
                  <button 
                    onClick={() => {
                      track('cta_click', { button: 'explore_work', location: 'hero', portfolio: 'dark' });
          ...
          <footer className="w-full max-w-7xl px-8 md:px-16 py-12 flex flex-col md:flex-row justify-between items-center border-t border-slate-800 gap-8">
            ...
            <div className="flex gap-8">
              <a 
                ...
                onClick={() => track('footer_social_click', { platform: 'twitter', portfolio: 'dark' })}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a 
                ...
                onClick={() => track('footer_social_click', { platform: 'github', portfolio: 'dark' })}
                target="_blank"
                rel="noopener noreferrer"
                className="text-[11px] uppercase tracking-widest font-bold text-slate-400 hover:text-blue-400 transition-colors"
              >
              ...
              <a 
                ...
                onClick={() => track('footer_social_click', { platform: 'linkedin', portfolio: 'dark' })}
                target="_blank"
                rel="noopener noreferrer"
                className="text-[11px] uppercase tracking-widest font-bold text-slate-400 hover:text-blue-400 transition-colors"
              >
